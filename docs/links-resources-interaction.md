...
| 页面 ID | 页面名称 | 导航入口 | 目的 |
|---|---|---|---|
| `link-library` | 传送门 | 桌面左侧／手机底部“传送门” | 分组、查找、排序并快速打开网页链接 |
| `resource-board` | 资料库 | 桌面左侧／手机底部“资料库” | 以横向分类看板浏览、创建、排序和移动资料 |
...
- 桌面左侧导航顺序：今日事、随手记、传送门、资料库。
- 手机底部导航顺序相同；四项等宽，不横向滚动。
- 心情模块入口在桌面端和手机端均隐藏。
...
1. 主导航中【传送门】和【资料库】完全替代【信息】；心情入口隐藏。
